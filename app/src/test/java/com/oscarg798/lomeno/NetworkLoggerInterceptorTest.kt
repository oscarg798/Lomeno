...
import com.oscarg798.lomeno.network.interceptor.NetworkLoggerInterceptor
import com.oscarg798.lomeno.network.mapper.NetworkLogEventMapperImpl
import com.oscarg798.lomeno.network.requestprocessor.DefaultRequestProcessor
import com.oscarg798.lomeno.network.source.NetworkLogSource
...
class NetworkLoggerInterceptorTest {
    ...
    private object Source : LogSource
